...
![XCP-ng](https://img.shields.io/badge/XCP--ng-F68B1F?style=flat-square&logoColor=white)
...
|---------|-------------|-------|
| 🐳 **[Docker Swarm](https://github.com/samet-ari/Docker-Swarm)** | High-availability cluster on VMware — NFS shared storage, 6 services, PCA/PRA resilience testing | Docker Swarm · NFS · Debian 12 |
| 🖥️ **Système & Réseau** | Linux server management & automation | Bash · Linux · Shell |
| 🏢 **Enterprise Network** | Full Linux enterprise infrastructure | DHCP · DNS · LDAP · NFS |
| 🔧 **Nested Virtualization** | 4 hypervisors in a nested environment | ESXi · Hyper-V · Proxmox · XCP-ng |
| 📊 **Linux Monitor** | Custom Python monitoring tool with automated alerts | Python · Linux |
| 🔐 **VPN Server** | Secure VPN server setup & administration | OpenVPN · Linux |
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/samet-ari/samet-ari/output/snake-dark.svg"/>
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/samet-ari/samet-ari/output/snake.svg"/>
  <img alt="Snake animation" src="https://raw.githubusercontent.com/samet-ari/samet-ari/output/snake.svg"/>
</picture>
...
|-------|--------------|------|
| 🎓 | **Red Hat System Administration** *(in progress)* | 2025 |
| 🛡️ | **Foundations of Cybersecurity** — Google | 2025 |
| ✅ | **ISTQB CTFL** — Foundation Level | 2023 |
| 🗣️ | **TOEIC** — Expression orale & écrite | 2024 |

---

## 🌍 Languages

🇫🇷 **French** — Fluent &nbsp;|&nbsp; 🇬🇧 **English** — Professional &nbsp;|&nbsp; 🇹🇷 **Turkish** — Native
